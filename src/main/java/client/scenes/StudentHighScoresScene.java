...
/**
 * Scene for displaying top scores of students. This scene should only be
 * visible for students as professors have a much more powerful and complex
 * scene for displaying student marks in {@link ViewMarksScene}.
 * 
 * @author Brendan Zhang
 *
 */
public class StudentHighScoresScene {
	...
	// TODO: Create a class for a students overall grade and display Student ID and
	// grade pair. Enable searching by Student ID
	@SuppressWarnings("unchecked")
	public StudentHighScoresScene(Stage stage, User user) {
